...
-- World layout (GRID_ORIGIN_X=7.5, GRID_SPACING_X=1.0, GRID_ORIGIN_Y=2.5, row spacing=+1.0):
--   row 1 (py=2.5): slot 1 (px=7.5) … slot 7 (px=13.5)
--   row 2 (py=3.5): slot 8 (px=7.5) …
--
